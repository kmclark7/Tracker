...
/**
 * Creates an abstract table model for the user database.
 */
...
class UserTableModel extends AbstractTableModel {
	...
	private Class<?>[] colClass = { int.class, String.class, String.class, String.class, String.class, int.class,
			String.class, String.class };
	UserDAO userDAO = new UserDAO();
	ArrayList<User> userModel = new ArrayList<User>(userDAO.arrayList);
	// private boolean[] isColumnEditable = {false, true, true, true, true,
	// true, true, true};
	...
	public Object getValueAt(int row, int col) {
		...
		case 0:
			return this.userData.get(row).getUserID();
		case 1:
			return this.userData.get(row).getPassword();
		case 2:
			return this.userData.get(row).getLastName();
		case 3:
			return this.userData.get(row).getFirstName();
		case 4:
			return this.userData.get(row).getPosition();
		case 5:
			return this.userData.get(row).getAccessLevel();
		case 6:
			return this.userData.get(row).getTeam();
		case 7:
			return this.userData.get(row).getEmail();
		default:
			return null;
		}
	}// end getValueAt
	...
	public void setValueAt(Object value, int row, int col) {
		...
		case 0: {
			userData.get(row).setUserID(Integer.parseInt((String) value));
			break;
		}
		case 1: {
			userData.get(row).setPassword((String) value);
			break;
		}
		case 2: {
			userData.get(row).setLastName((String) value);
			break;
		}
		case 3: {
			userData.get(row).setFirstName((String) value);
			break;
		}
		case 4: {
			userData.get(row).setPosition((String) value);
			break;
		}
		case 5: {
			userData.get(row).setAccessLevel(Integer.parseInt((String) value));
			break;
		}
		case 6: {
			userData.get(row).setTeam((String) value);
			break;
		}
		case 7: {
			userData.get(row).setEmail((String) value);
			break;
		}
